...
release = "second release 03-02-2014 by Martin Stöter (stoeter(at)mpi-cbg.de)";
html = "<html>"
...
for (i = 0; i < l; i++) {
	if (fileListToLog) print(fileList[i], channelsTags[1], indexOf(fileList[i],channelsTags[1]));
