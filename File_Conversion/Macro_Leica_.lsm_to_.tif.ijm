//Leica_.lsm_to_.tif
macroName = "Leica_.lsm_to_.tif";
macroDescription = "This macro imports .lsm image files from Leica microscope, splits channels and saves stack for each channel.";
//Macro uses Bioformats of Fiji
//
//first release 15-11-2013 by Martin Stöter (stoeter(at)mpi-cbg.de)
html = "<html>"
	+"<font color=red>" + macroName + " (release 2013-11-15)</font> <br>"
